...
var documents = [{
    ...
    "title": "404",
    "body": "404 Page not found!아래 검색 바를 이용하시거나 페이지에 방문해 주세요! "
    }, {
    "id": 1,
    "url": "http://localhost:4000/about",
    "title": "Memoirs, a free minimalist Jekyll blogging theme with modern design",
    "body": "This website is a demonstration to see Memoirs Jekyll them in action. The theme is compatible with Github pages, in fact even this demo itself is created with Github Pages and hosted with Github.  Get Memoirs for Jekyll → "
    }, {
    "id": 2,
    ...
    "title": "Contact",
    "body": "  RealCoder에 메시지를 보내주세요. 곧 답장해 드립니다!   "
    }, {
    "id": 4,
    ...
    "id": 5,
    "url": "http://localhost:4000/math",
    "title": "",
    "body": "수학은 세상을 바라보는 강력한 시각이자 호기심의 원천입니다. 또한 수학은 개발자에게 있어 기술을 이해하는 깊이를 더해줍니다. 지금부터 저와 같이 수학을 음미하면서 끊임없는 호기심과 이해의 깊이를 함께 느껴봅시다. "
    }, {
    "id": 6,
